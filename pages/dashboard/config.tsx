...
import AdminDocumentConfigLayout from "@/views/layouts/AdminLayout/config/document";
import AdminFacilityConfigLayout from "@/views/layouts/AdminLayout/config/facility";
...
const DashboardConfiguration: React.FC = () => {
  ...
  return (
    <DashboardLayout pageName="Pengaturan Data" role={user.role}>
      ...
      <AdminFacilityConfigLayout id={user.id} company_id={user.company_id} />
    </DashboardLayout>
  );
};
