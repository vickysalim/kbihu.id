...
const DashboardPilgrimsDetail: React.FC = () => {
  ...
  const handleEdit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      await axios
        .put(`/api/pilgrims/data/update/${router.query.id}`, {
  ...
  const handleDelete = async () => {
    if (
      ...
      try {
        await axios
          .delete("/api/pilgrims/data/delete", {
            data: {
              id: router.query.id,
            },
          })
        ...
        <div className="grid grid-cols-1 gap-4 h-min-content">
            ...
            <div className="px-4 pt-3 pb-2">
              ...
              <div className="mb-2">
                <label
                  ...
                  className="text-sm font-semibold text-gray-500"
                >
                  {pilgrim.user_profile.gender == "Laki-laki" ? "Bin" : "Binti"}
                </label>
                <input
                  type="text"
                  id="nasab_name"
          ...
          <div className="flex flex-col bg-white rounded-lg">
            ...
            <div className="px-4 pt-3 pb-2">
              ...
              <button
                type="button"
                className="text-red-500 active:text-red-600 font-bold uppercase text-xs outline-none focus:outline-none"
