...
const DashboardPilgrimsAdd: React.FC = () => {
    ...
    const validateInsert = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            validation.parse({ departure_year: pilgrim.user_profile.departure_year,
    ...
    return (
        <DashboardLayout pageName='Tambah Jemaah Haji' role='Admin'>
            <form className="grid grid-cols-1 sm:grid-cols-2 gap-4" onSubmit={validateInsert}>
                <div className="grid grid-cols-1 gap-4 h-min-content">
                    ...
                    <div className='flex flex-col bg-white rounded-lg'>
                        ...
                        <div className='px-4 pt-3 pb-2'>
                            <div className="mb-2">
                                ...
                                />
                                { validationMessage.reg_number && <p className='text-sm text-red-500'>{validationMessage.reg_number}</p> }
                            </div>
                            <div className="mb-2">
                                <label htmlFor='portion_number' className='text-sm font-semibold text-gray-500' title='Wajib dimasukkan'>
                                    Nomor Porsi
                                ...
                                <input
                                    ...
                                    className='w-full rounded-lg border border-gray-300 p-2 focus:outline-none focus:border-blue-500'
                                />
                                { validationMessage.portion_number && <p className='text-sm text-red-500'>{validationMessage.portion_number}</p> }
                            </div>
                            <div className="mb-2">
                                <label htmlFor='bank' className='text-sm font-semibold text-gray-500' title='Wajib dimasukkan'>
                                    Bank
                                    <span className='text-red-500'>*</span>
                                </label>
                                <input
                                    ...
                                    className='w-full rounded-lg border border-gray-300 p-2 focus:outline-none focus:border-blue-500'
                                />
                                { validationMessage.bank && <p className='text-sm text-red-500'>{validationMessage.bank}</p> }
                            </div>
                            <div className="mb-2">
                                ...
                                <input
                                    ...
                                    className='w-full rounded-lg border border-gray-300 p-2 focus:outline-none focus:border-blue-500'
                                />
                                { validationMessage.bank_branch && <p className='text-sm text-red-500'>{validationMessage.bank_branch}</p> }
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='flex flex-col bg-white rounded-lg'>
                        ...
                        <div className='px-4 pt-3 pb-2'>
                            <div className="mb-2">
                                <label htmlFor='passport_number' className='text-sm font-semibold text-gray-500' title='Wajib dimasukkan'>
                                    Nomor Paspor
                                    <span className='text-red-500'>*</span>
                                </label>
                                <input
                                    ...
                                    className='w-full rounded-lg border border-gray-300 p-2 focus:outline-none focus:border-blue-500'
                                />
                                { validationMessage.passport_number && <p className='text-sm text-red-500'>{validationMessage.passport_number}</p> }
                            </div>
                            <div className="mb-2">
                                <label htmlFor='passport_name' className='text-sm font-semibold text-gray-500' title='Wajib dimasukkan'>
                                    Nama Paspor
                                    <span className='text-red-500'>*</span>
                                </label>
                                <input
                                    ...
                                    className='w-full rounded-lg border border-gray-300 p-2 focus:outline-none focus:border-blue-500'
                                />
                                { validationMessage.passport_name && <p className='text-sm text-red-500'>{validationMessage.passport_name}</p> }
                            </div>
                            <div className="mb-2">
                                <label htmlFor='passport_pob' className='text-sm font-semibold text-gray-500' title='Wajib dimasukkan'>
                                    Tempat Lahir Paspor
                                    <span className='text-red-500'>*</span>
                                </label>
                                <input
                                    ...
                                    className='w-full rounded-lg border border-gray-300 p-2 focus:outline-none focus:border-blue-500'
                                />
                                { validationMessage.passport_pob && <p className='text-sm text-red-500'>{validationMessage.passport_pob}</p> }
                            </div>
                            <div className="mb-2">
                                <label htmlFor='passport_dob' className='text-sm font-semibold text-gray-500' title='Wajib dimasukkan'>
                                ...
                                <input
                                    ...
                                    className='w-full rounded-lg border border-gray-300 p-2 focus:outline-none focus:border-blue-500'
                                />
                                { validationMessage.passport_dob && <p className='text-sm text-red-500'>{validationMessage.passport_dob}</p> }
                            </div>
                            <div className="mb-2">
                                <label htmlFor='passport_issue_date' className='text-sm font-semibold text-gray-500' title='Wajib dimasukkan'>
                                ...
                                <input
                                    ...
                                    className='w-full rounded-lg border border-gray-300 p-2 focus:outline-none focus:border-blue-500'
                                />
                                { validationMessage.passport_issue_date && <p className='text-sm text-red-500'>{validationMessage.passport_issue_date}</p> }
                            </div>
                            <div className="mb-2">
                                <label htmlFor='passport_expiry_date' className='text-sm font-semibold text-gray-500' title='Wajib dimasukkan'>
                                ...
                                <input
                                    ...
                                    className='w-full rounded-lg border border-gray-300 p-2 focus:outline-none focus:border-blue-500'
                                />
                                { validationMessage.passport_expiry_date && <p className='text-sm text-red-500'>{validationMessage.passport_expiry_date}</p> }
                            </div>
                            <div className="mb-2">
                                <label htmlFor='passport_issue_office' className='text-sm font-semibold text-gray-500' title='Wajib dimasukkan'>
                                ...
                                <input
                                    ...
                                    className='w-full rounded-lg border border-gray-300 p-2 focus:outline-none focus:border-blue-500'
                                />
                                { validationMessage.passport_issue_office && <p className='text-sm text-red-500'>{validationMessage.passport_issue_office}</p> }
                            </div>
                            <div className="mb-2">
                                ...
                                <input
                                    ...
                                    className='w-full rounded-lg border border-gray-300 p-2 focus:outline-none focus:border-blue-500'
                                />
                                { validationMessage.passport_endorsement && <p className='text-sm text-red-500'>{validationMessage.passport_endorsement}</p> }
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='flex flex-col bg-white rounded-lg'>
                        ...
                        <div className='px-4 pt-3 pb-2'>
                            <div className="mb-2">
                                <label htmlFor='identity_number' className='text-sm font-semibold text-gray-500' title='Wajib dimasukkan'>
                                    Nomor KTP
                                    <span className='text-red-500'>*</span>
                                </label>
                                <input
                                    ...
                                    className='w-full rounded-lg border border-gray-300 p-2 focus:outline-none focus:border-blue-500'
                                />
                                { validationMessage.identity_number && <p className='text-sm text-red-500'>{validationMessage.identity_number}</p> }
                            </div>
                            <div className="mb-2">
                                <label htmlFor='departure_year' className='text-sm font-semibold text-gray-500' title='Wajib dimasukkan'>
                                    Tahun Keberangkatan
                                    <span className='text-red-500'>*</span>
                                </label>
                                <input
                                    ...
                                    className='w-full rounded-lg border border-gray-300 p-2 focus:outline-none focus:border-blue-500'
                                />
                                { validationMessage.departure_year && <p className='text-sm text-red-500'>{validationMessage.departure_year}</p> }
                            </div>
                            <div className="mb-2">
                                <label htmlFor='phone_number' className='text-sm font-semibold text-gray-500' title='Wajib dimasukkan'>
                                    Nomor Telepon
                                    <span className='text-red-500'>*</span>
                                </label>
                                <input
                ...
                <div className="grid grid-cols-1 gap-4 h-min-content">
                    ...
                    <div className='flex flex-col bg-white rounded-lg'>
                        ...
                        <div className='px-4 pt-3 pb-2'>
                            ...
                            <div className="mb-2">
                                <label htmlFor='nasab_name' className='text-sm font-semibold text-gray-500' title='Wajib dimasukkan'>
                                    {
                                ...
                                <input
                                    ...
                                    className='w-full rounded-lg border border-gray-300 p-2 focus:outline-none focus:border-blue-500'
                                />
                                { validationMessage.nasab_name && <p className='text-sm text-red-500'>{validationMessage.nasab_name}</p> }
                            </div>
                            <div className="mb-2">
                                <label htmlFor='gender' className='text-sm font-semibold text-gray-500' title='Wajib dimasukkan'>
                                    Jenis Kelamin
                                    <span className='text-red-500'>*</span>
                                </label>
                                ...
                                { validationMessage.gender && <p className='text-sm text-red-500'>{validationMessage.gender}</p> }
                            </div>
                            <div className="mb-2">
                                ...
                                <input
                                    ...
                                    className='w-full rounded-lg border border-gray-300 p-2 focus:outline-none focus:border-blue-500'
                                />
                                { validationMessage.marital_status && <p className='text-sm text-red-500'>{validationMessage.marital_status}</p> }
                            </div>
                            <div className="mb-2">
                                ...
                                <input
                                    ...
                                    className='w-full rounded-lg border border-gray-300 p-2 focus:outline-none focus:border-blue-500'
                                />
                                { validationMessage.blood_type && <p className='text-sm text-red-500'>{validationMessage.blood_type}</p> }
                            </div>
                            <div className="mb-2">
                                <label htmlFor='pob' className='text-sm font-semibold text-gray-500' title='Wajib dimasukkan'>
                                    Tempat Lahir
                                    <span className='text-red-500'>*</span>
                                </label>
                                <input
                                    ...
                                    className='w-full rounded-lg border border-gray-300 p-2 focus:outline-none focus:border-blue-500'
                                />
                                { validationMessage.pob && <p className='text-sm text-red-500'>{validationMessage.pob}</p> }
                            </div>
                            <div className="mb-2">
                                <label htmlFor='dob' className='text-sm font-semibold text-gray-500' title='Wajib dimasukkan'>
                                    Tanggal Lahir
                                    <span className='text-red-500'>*</span>
                                </label>
                                <input
                                    ...
                                    className='w-full rounded-lg border border-gray-300 p-2 focus:outline-none focus:border-blue-500'
                                />
                                { validationMessage.dob && <p className='text-sm text-red-500'>{validationMessage.dob}</p> }
                            </div>
                            <div className="mb-2">
                                <label htmlFor='province' className='text-sm font-semibold text-gray-500' title='Wajib dimasukkan'>
                                    Provinsi
                                    <span className='text-red-500'>*</span>
                                </label>
                                <input
                            ...
                            <div className="mb-2">
                                <label htmlFor='city' className='text-sm font-semibold text-gray-500' title='Wajib dimasukkan'>
                                    Kabupaten/Kota
                                    <span className='text-red-500'>*</span>
                                </label>
                                <input
                            ...
                            <div className="mb-2">
                                <label htmlFor='district' className='text-sm font-semibold text-gray-500' title='Wajib dimasukkan'>
                                    Kecamatan
                                    <span className='text-red-500'>*</span>
                                </label>
                                <input
                            ...
                            <div className="mb-2">
                                <label htmlFor='subdistrict' className='text-sm font-semibold text-gray-500' title='Wajib dimasukkan'>
                                    Desa/Kelurahan
                                    <span className='text-red-500'>*</span>
                                </label>
                                <input
                            ...
                            <div className="mb-2">
                                <label htmlFor='street' className='text-sm font-semibold text-gray-500' title='Wajib dimasukkan'>
                                    Alamat
                                    <span className='text-red-500'>*</span>
                                </label>
                                <input
                            ...
                            <div className="mb-2">
                                <label htmlFor='postal_code' className='text-sm font-semibold text-gray-500' title='Wajib dimasukkan'>
                                    Kode Pos
                                    <span className='text-red-500'>*</span>
                                </label>
                                <input
                            ...
                            <div className="mb-2">
                                ...
                                <input
                                    ...
                                    className='w-full rounded-lg border border-gray-300 p-2 focus:outline-none focus:border-blue-500'
                                />
                                { validationMessage.education && <p className='text-sm text-red-500'>{validationMessage.education}</p> }
                            </div>
                            <div className="mb-2">
                                ...
                                <input
                                    ...
                                    className='w-full rounded-lg border border-gray-300 p-2 focus:outline-none focus:border-blue-500'
                                />
                                { validationMessage.job && <p className='text-sm text-red-500'>{validationMessage.job}</p> }
                            </div>
                        </div>
                    </div>
