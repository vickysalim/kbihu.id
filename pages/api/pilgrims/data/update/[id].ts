...
export default async function handler(
    ...
    try {
        const { departure_year, reg_number, portion_number, bank, bank_branch, name, nasab_name, gender, marital_status, blood_type, pob, dob, street, postal_code, subdistrict, district, city, province, education, job, passport_number, passport_name, passport_pob, passport_dob, passport_issue_date, passport_expiry_date, passport_issue_office, passport_endorsement, identity_number, phone_number } = req.body
        ...
        await prisma.user_profile.update({
            ...
            data: {
                ...
                passport_issue_date: new Date(passport_issue_date) || profileData.passport_issue_date,
                passport_expiry_date: new Date(passport_expiry_date) || profileData.passport_expiry_date,
                passport_issue_office: passport_issue_office || profileData.passport_issue_office,
