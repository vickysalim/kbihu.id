...
const AdminPilgrimsTabLayout = ({ id }: AdminPilgrimsTabLayoutProps) => {
    return (
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4'>
            <button className='border-b-4 border-b-blue-500 text-blue-500 rounded-lg p-2 mb-4 text-center font-semibold' onClick={() => window.location.href = `/dashboard/pilgrims/${id}`}>Data Jemaah Haji</button>
