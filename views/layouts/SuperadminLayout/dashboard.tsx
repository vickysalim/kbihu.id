...
import { faMap, faXmark, faUser as faUserSolid, faPhone } from '@fortawesome/free-solid-svg-icons'
    ...
    return (
        <>        
            ...
            <div>
                ...
                <SuperadminInsertCompanyLayout loadData={loadMainData}/>
                            ...
                            <tbody className="divide-y">
                                {company.map((item, index) => (
                                    <tr key={index} className="text-gray-700">
                                        ...
                                        <td className="px-4 py-3 text-sm">{item.phone_number}</td>
                                        <td className="px-4 py-3">
                                            <div className="flex items-center space-x-4 text-sm">
                                                ...
                                                <button className="bg-gray-500 text-white active:bg-gray-600 font-bold uppercase text-xs px-4 py-2 rounded shadow outline-none focus:outline-none mr-1 mb-1">
