...
const AdminDocumentConfigLayout = ({ id, company_id }: any): JSX.Element => {
    ...
    const validateInsertDocument = async (e: React.FormEvent<HTMLFormElement>) => {
        e.preventDefault()
                        ...
                        <form onSubmit={validateInsertDocument}>
                            <div className="mb-2">
                                ...
                                <input
                                    ...
                                    onChange={(e) => setInsertDocument({...insertDocument, name: e.target.value})}
                                />
                            </div>
                            ...
                            <div className='mb-2 flex items-center gap-x-1'>
                                ...
                                />
                                <label htmlFor='document_all'>Dokumen ini terbatas untuk tahun keberangkatan tertentu</label>
                            </div>
